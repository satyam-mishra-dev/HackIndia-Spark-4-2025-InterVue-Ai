...
const AuthForm = ({ type }: { type: FormType }) => {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...(type === "sign-up" && { name: "" }), // Include `name` only for sign-up
      email: "",
      password: "",
    },
  });
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormField
              ...
              name="password"
              label="Password"
              placeholder="x093i0ei"
              type="password"
            />
            <Button className="btn" type="submit">
              {isSignIn ? "Log in your Account" : "Create an Account"}
            </Button>
          </form>
        </Form>
        <p>
          {isSignIn ? (
            <span>
              ...
              <a href="/sign-up" className="text-primary-100">
                Sign Up
              </a>
            </span>
          ) : (
            <span>
              ...
              <a href="/sign-in" className="text-primary-100">
                Sign In
              </a>
            </span>
          )}
